...
namespace ArchiMetrics.CodeReview.Rules.Code
{
	...
	internal class ImmediateTaskWaitRule : CodeEvaluationBase, ICweMapping
	{
		public IReadOnlyList<string> CweIds { get; } = new[] { "CWE-1049" };
		public Iso5055Category Iso5055Category => Iso5055Category.PerformanceEfficiency | Iso5055Category.Reliability;
